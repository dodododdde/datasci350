...
[![](figures/folders.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/folders.png"}
[![](figures/home-folder.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/home-folder.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/github-folder.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/github-folder.png"}
[![](figures/github-folder02.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/github-folder02.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/flux01.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/flux01.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/abstraction.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/abstraction.png"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/tokens.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/tokens.png"}

[![](figures/unsupervised.webp){width="100%"}](#){data-modal-type="image" data-modal-url="figures/unsupervised.webp"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/dropout.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/dropout.png"}

[![](figures/overfitting.jpg){width="80%"}](#){data-modal-type="image" data-modal-url="figures/overfitting.jpg"}
:::
:::
:::
:::
...
[![](figures/biases02.png){width="75%"}](#){data-modal-type="image" data-modal-url="figures/biases02.png"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/europe.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/europe.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/security.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/security.png"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/components.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/components.png"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/context.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/context.png"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/prompt-elements.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/prompt-elements.png"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/instructions.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/instructions.png"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/format.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/format.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/copilot.jpeg){width="100%"}](#){data-modal-type="image" data-modal-url="figures/copilot.jpeg"}
...
:::{.column width="50%"}
:::{style="text-align: center;"}
[![](figures/unexpectedcopilot2.webp){width="100%"}](#){data-modal-type="image" data-modal-url="figures/unexpectedcopilot2.webp"}
:::
:::
:::
:::
...
[![](figures/prompt_invitation.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/prompt_invitation.png"}
...
[![](figures/bubble_sort.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/bubble_sort.png"}
:::
...
[![](figures/relative_std.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/relative_std.gif"}
:::
...
:::{style="text-align: center;"}
[![](figures/doc_command.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/doc_command.png"}
:::
:::
...
:::{style="text-align: center;"}
[![](figures/tests.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/tests.png"}
:::
:::
...
[![](figures/github_search.png){width="70%"}](#){data-modal-type="image" data-modal-url="figures/github_search.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center; margin-top: -30px;"}
[![](figures/websearch.png){width="70%"}](#){data-modal-type="image" data-modal-url="figures/websearch.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
:::{style="text-align: center; margin-top: -30px;"}
[![](figures/codespaces-extension.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/codespaces-extension.png"}
...
[![](figures/codespaces.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/codespaces.png"}
:::

## GitHub Codespaces

:::{style="margin-top: 30px; font-size: 26px; text-align: center;"}
[![](figures/codespaces01.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/codespaces01.png"}
:::

## GitHub Codespaces

:::{style="margin-top: 30px; font-size: 26px; text-align: center;"}
[![](figures/codespaces02.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/codespaces02.png"}
:::

## GitHub Codespaces

:::{style="margin-top: 30px; font-size: 26px; text-align: center;"}
[![](figures/codespaces03.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/codespaces03.png"}
:::

## GitHub Codespaces

:::{style="margin-top: 30px; font-size: 26px; text-align: center;"}
[![](figures/codespaces04.png){width="80%"}](#){data-modal-type="image" data-modal-url="figures/codespaces04.png"}
:::
