...
[![](figures/roocode-setup.png){width="90%"}](#){data-modal-type="image" data-modal-url="figures/roocode-setup.png"}
:::
:::
:::
:::
...
:::{.column width="50%"}
[![](figures/roocode-result.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/roocode-result.png"}
:::
:::
:::
...
:::{.columns}
:::{.column width="50%"}
[![](figures/roocode-agent.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/roocode-agent.png"}
:::
...
[![](figures/cline.png){width="100%"}](#){data-modal-type="image" data-modal-url="figures/cline.png"}
