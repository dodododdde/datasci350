...
:::{.columns}
:::{.column width="50%"}
[![](figures/docker-meme02.jpg){width="100%"}](#){data-modal-type="image" data-modal-url="figures/docker-meme02.jpg"}
:::
:::{.column width="50%"}
[![](figures/docker-meme03.webp){width="100%"}](#){data-modal-type="image" data-modal-url="figures/docker-meme03.webp"}
:::
:::
:::
:::
