...
[![](figures/copilot.jpeg){width="55%"}](#){data-modal-type="image" data-modal-url="figures/copilot.jpeg"}
...
:::{style="margin-top: 30px; font-size: 21px;"}
[![](figures/readme-gif.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/readme-gif.gif"}
:::

## GitHub Copilot

:::{style="margin-top: 30px; font-size: 21px; text-align: center;"}
[![](figures/copilot4.gif){width="100%"}](#){data-modal-type="image" data-modal-url="figures/copilot4.gif"}
:::

## GitHub Copilot

:::{style="margin-top: 30px; font-size: 21px; text-align: center;"}
[![](figures/copilot5.webp){width="100%"}](#){data-modal-type="image" data-modal-url="figures/copilot5.webp"}
:::
